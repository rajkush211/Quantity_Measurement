...
public class QuantityAdd implements IQtyOperation{
    @Override
    public Quantity add(Quantity quantity1, Quantity quantity2, Unit expectedUnit) throws QuantityException {
        ...
        return new Quantity(expectedUnit, ((quantity1.VALUE * quantity1.UNIT.baseUnitConversion +
                            quantity2.VALUE * quantity2.UNIT.baseUnitConversion) / (expectedUnit.baseUnitConversion)));
    }
}
